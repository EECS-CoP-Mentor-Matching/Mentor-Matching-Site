...
function ProfileEdit(props: ProfileEditProps) {
    ...
    const uploadFile = async (file: ArrayBuffer) => {
        const fileRef = ref(storage, 'profilePictures/' + props.uid); // File path in storage
    ...
    const handleSubmit = async (event: any) => {
        ...
        try {
            ...
            // } as UserProfile;
            // await userService.updateUserProfile(props.uid, updatedProfileData);
